    ...
    if ($action === 'place_order') {
        ...
        try {
            ...
            $sql = "INSERT INTO orders (
                    ...
                    ) VALUES (?, ?, ?, NOW(), ?, 0, ?, ?, 'pending', 'pending', ?, ?, ?, ?, ?, ?, ?, NOW())";
            ...
            $sql = "INSERT INTO shop_payments (
                    ...
                    ) VALUES (?, ?, ?, 'order_payment', ?, 0, ?, 1, 1, NOW(), ?, 'pending', 'shop', NOW())";
...
<!-- Same CSS and HTML as before - no changes needed -->
<style>
    .cart-table {
        width: 100%;
        ...
        <form method="POST" action="" id="cartForm">
            ...
            <div style="margin-top: 20px; background: white; border: 1px solid #E5EDE7; border-radius: 12px; padding: 20px 24px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    ...
                    <div style="grid-column: 1 / -1;">
                        <label style="display: block; font-weight: 600; font-size: 14px; color: #14532D; margin-bottom: 4px;">Payment Method</label>
                        <select name="payment_method" class="form-input" style="width: 100%; padding: 10px 14px; border: 2px solid #E5EDE7; border-radius: 8px; font-family: 'Inter', sans-serif; font-size: 14px;">
...
<?php require_once __DIR__ . '/../includes/shop_footer.php'; ?><?php
/**
 * SAMRIDHI AGRO - Shop Cart
 * 
 * This page displays the shop's cart and allows placing orders.
