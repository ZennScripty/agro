<?php
/**
 * SAMRIDHI AGRO - Shop Login
 * 
 * This page handles shop authentication with secure login functionality.
 * 
...
// If already logged in and is shop, redirect to dashboard
        ...
        if (empty($username) || empty($password)) {
            ...
            if ($authResult['success']) {
                ...
                if (hasRole('shop')) {
                    ...
                    $db = getDB();
                    $sql = "SELECT status FROM shops WHERE user_id = ?";
                    ...
                    if ($shop && $shop['status'] === 'approved') {
                        ...
                        // Logout non-approved shop
                        logoutUser();
                        $error = 'Your shop account is pending approval. Please wait for admin approval.';
                    }
                } else {
                    // Logout non-shop user
                    logoutUser();
                    $error = 'You do not have shop access. Please use the correct portal.';
                }
            } else {
...
<head>
    ...
    <title>Shop Login - Samridhi Agro</title>
            ...
            <div class="login-card">
                ...
                <div class="login-footer">
                    ...
                    <div class="portal-links">
                        ...
                        <a href="../agent/login.php"><i class="fas fa-user-tie"></i> Agent</a>
                    </div>
                </div>
            </div>
        </div>
