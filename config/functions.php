 ...
 */
function getPagination($totalItems, $currentPage, $perPage = PAGINATION_DEFAULT_LIMIT, $url = '?page={page}', $range = PAGINATION_PAGE_RANGE) {
    ...
    if ($currentPage > 1) {
        $html .= '<li class="page-item"><a class="page-link" href="' . str_replace('{page}', $prevPage, $url) . '">Previous</a></li>';
    } else {
    ...
    if ($end < $totalPages) {
        ...
        $html .= '<li class="page-item"><a class="page-link" href="' . str_replace('{page}', $totalPages, $url) . '">' . $totalPages . '</a></li>';
    }
    
    // Next button
    $nextPage = $currentPage + 1;
    if ($currentPage < $totalPages) {
        $html .= '<li class="page-item"><a class="page-link" href="' . str_replace('{page}', $nextPage, $url) . '">Next</a></li>';
    } else {
