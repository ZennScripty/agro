...
<style>
    ...
    @media (max-width: 768px) {
        ...
        /* Hide holiday badges and weekly off badges on mobile */
        .calendar-grid .day-cell .holiday-badge,
        .calendar-grid .day-cell .weekly-holiday-badge {
    ...
    <div class="attendance-container">
        ...
        <div class="attendance-card">
            ...
            <div class="info-text">
                ...
                You can check-in from anywhere as an agent. No geofence restrictions.
            </div>
        </div>
    ...
    <div style="margin-top: 24px;">
        <div class="calendar-container">
            ...
            <div class="calendar-grid" id="calendarGrid">
                ...
                // Display day names with weekly holiday highlighting
                ...
                for ($day = 1; $day <= $daysInMonth; $day++) {
                    ...
                    // Display attendance status as text badge
                    if ($attStatus) {
                        $statusLabels = [
                            'present' => 'P',
                            'absent' => 'A',
                    ...
                    // Show holiday badges (hidden on mobile via CSS)
                    if ($isHoliday) {
...
<script>
    ...
    // ============================================
    // DATE DETAIL POPOVER
    // Tap/click a date cell to see its detail.
    // ============================================
