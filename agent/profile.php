    ...
    if ($action === 'update_profile') {
        ...
        if (isset($_FILES['avatar']) && $_FILES['avatar']['error'] === UPLOAD_ERR_OK) {
            ...
            if ($uploadResult['success']) {
                ...
                if (!empty($agent['avatar']) && file_exists($uploadDir . $agent['avatar'])) {
                    @unlink($uploadDir . $agent['avatar']);
                }
            } else {
    ...
    <div class="profile-sidebar">
        <div class="profile-avatar-wrapper">
            <div class="profile-avatar">
                ...
                <?php else: ?>
                    <span class="avatar-text"><?php echo strtoupper(substr($agent['full_name'] ?? 'A', 0, 2)); ?></span>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="avatar-preview-wrap">
                        <div class="preview-box" id="avatarPreview">
                            <?php if (!empty($agent['avatar']) && file_exists('../uploads/avatars/' . $agent['avatar'])): ?>
                                <img src="../uploads/avatars/<?php echo escapeHtml($agent['avatar']); ?>" alt="Avatar">
                            <?php else: ?>
