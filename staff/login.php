<?php
/**
 * SAMRIDHI AGRO - Staff Login
 * 
 * This page handles staff authentication with secure login functionality.
 * 
        ...
        if (empty($username) || empty($password)) {
            ...
            if ($authResult['success']) {
                ...
                if (hasRole('staff')) {
                    ...
                    // Logout non-staff user
                    logoutUser();
                    $error = 'You do not have staff access. Please use the correct portal.';
                }
            } else {
...
<head>
    ...
    <title>Staff Login - Samridhi Agro</title>
