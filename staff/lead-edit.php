<?php
/**
 * SAMRIDHI AGRO - Staff Edit Lead
 * 
 * This page allows staff members to update existing leads.
 * 
...
// If no ID or invalid ID, redirect to leads list
if ($leadId <= 0) {
...
// ============================================
// FIXED: Get lead data with correct aliases
// ============================================
$sql = "SELECT sl.*, 
        ag.agent_code,
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST[CSRF_TOKEN_NAME]) || !verifyCsrfToken($_POST[CSRF_TOKEN_NAME])) {
        ...
        redirect('staff/lead-edit.php?id=' . $leadId);
        exit;
    }
    ...
    if (!$hasErrors) {
        try {
            ...
            logActivity(
                ...
                $_SESSION['user_id'],
                'leads',
                'Updated lead: ' . $formData['title'] . ' (ID: ' . $leadId . ')'
            );
            ...
            setFlashMessage('error', 'Failed to update lead. Please try again.');
            redirect('staff/lead-edit.php?id=' . $leadId);
            exit;
        }
    }
...
<style>
    ...
    .lead-info-box .info-item .label {
        color: #6B7A7B;
    }
    
    .lead-info-box .info-item .value {
        font-weight: 500;
        color: #052E16;
    }
    ...
    .badge-status.badge-new { background: #DBEAFE; color: #1E40AF; }
    .badge-status.badge-contacted { background: #FEF3C7; color: #92400E; }
    .badge-status.badge-qualified { background: #EDE9FE; color: #5B21B6; }
    .badge-status.badge-converted { background: #DCFCE7; color: #065F46; }
    .badge-status.badge-lost { background: #FEE2E2; color: #991B1B; }
...
<div class="content-card">
    <div class="card-header">
        ...
        <div style="display: flex; gap: 8px;">
            <a href="lead-view.php?id=<?php echo $lead['id']; ?>" class="card-action">
    ...
    <div class="lead-info-box">
        <div class="info-item">
            ...
            <span class="value"><?php echo escapeHtml($lead['staff_name']); ?></span>
        </div>
        <div class="info-item">
            <span class="label">Created Date</span>
            <span class="value"><?php echo formatDate($lead['created_at']); ?></span>
        </div>
        <div class="info-item">
            <span class="label">Current Status</span>
            <span class="value">
                <span class="badge-status badge-<?php echo $lead['status']; ?>">
                    <?php echo ucfirst($lead['status']); ?>
                </span>
                <span style="margin-left: 8px; font-weight: 400; color: #6B7A7B;">
                    Priority: <?php echo ucfirst($lead['priority']); ?>
                </span>
            </span>
        </div>
    </div>
    ...
    <form method="POST" action="" id="leadForm" novalidate>
        ...
        <div style="margin-top: 24px; padding-top: 20px; border-top: 1px solid #E5EDE7; display: flex; gap: 12px;">
            <button type="submit" class="btn-primary" id="submitBtn">
                <i class="fas fa-save"></i> <span id="btnText">Update Lead</span>
